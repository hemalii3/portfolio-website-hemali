    ...
    <section id="education" className="py-20 bg-data-darkBg">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold mb-12 text-center relative">
          <span className="text-data-accent">Education</span>
        </h2>
          ...
          <div className="relative">
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="md:text-right md:pr-12 animate-fade-in" style={{animationDelay: '0.1s'}}>
                ...
                <h4 className="text-xl mb-4 text-data-secondary">University of Vienna</h4>
              ...
              <div className="relative md:pl-12 animate-fade-in" style={{animationDelay: '0.2s'}}>
                <div className="hidden md:block absolute -left-3 top-0 transform -translate-y-1/3 bg-data-secondary p-3 rounded-full">
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="md:hidden animate-fade-in" style={{animationDelay: '0.3s'}}>
                ...
                <h4 className="text-xl mb-4 text-data-secondary">[College Name]</h4>
              ...
              <div className="relative md:pr-12 order-2 md:order-1 animate-fade-in" style={{animationDelay: '0.4s'}}>
                <div className="hidden md:block absolute -right-3 top-0 transform -translate-y-1/3 bg-data-secondary p-3 rounded-full">
                  <GraduationCap size={24} className="text-data-darkBg" />
                </div>
              </div>
